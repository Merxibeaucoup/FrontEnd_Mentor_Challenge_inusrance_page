  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__top">
        ...
        <div className="footer__top__icons">
          <div className="footer__top__icons-1">
            <svg
              className="footer__top__icons-icon"
          ...
          <div className="footer__top__icons-2">
            <svg
              className="footer__top__icons-icon"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
          ...
          <div className="footer__top__icons-3">
            <svg
              className="footer__top__icons-icon"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
          ...
          <div className="footer__top__icons-4">
            <svg
              className="footer__top__icons-icon"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
      ...
      <div className="footer__bottom">
        <div className="footer__bottom__wrapper">
          <p className="footer__bottom__heading">Our company</p>
          <ul className="footer__bottom__ul">
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-1">How we work</p>
            </li>
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-2">Why insure?</p>
            </li>
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-3">view plans</p>
            </li>
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-4">reviews</p>
            </li>
          </ul>
        </div>
        <div className="footer__bottom__wrapper">
          <p className="footer__bottom__heading">Help me</p>
          <ul className="footer__bottom__ul">
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-1">faq</p>
            </li>
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-2">termsof use</p>
            </li>
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-3">privacy policy</p>
            </li>
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-4">cookies</p>
            </li>
          </ul>
        </div>
        <div className="footer__bottom__wrapper">
          <p className="footer__bottom__heading">contact</p>
          <ul className="footer__bottom__ul">
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-1">sales</p>
            </li>
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-2">support</p>
            </li>
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-3">live chat</p>
            </li>
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-3">&nbsp;</p>
            </li>
          </ul>
        </div>
        <div className="footer__bottom__wrapper">
          <p className="footer__bottom__heading">Others</p>
          <ul className="footer__bottom__ul">
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-1">careers</p>
            </li>
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-2">press</p>
            </li>
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-3">licenses</p>
            </li>
            <li className="footer__bottom__ul__list">
              <p className="footer__bottom__ul__list-3">&nbsp;</p>
            </li>
